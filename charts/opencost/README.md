...
![Version: 2.5.32](https://img.shields.io/badge/Version-2.5.32-informational?style=flat-square)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
![AppVersion: 1.121.2](https://img.shields.io/badge/AppVersion-1.121.2-informational?style=flat-square)
...
| clusterName | string | `""` | Deprecated, use `clusterDomain` instead. Kept for backwards compatibility and takes precedence over `clusterDomain` when non-empty. |
